...
<html lang="uk">
  ...
  <body>
		<div class="container">
			...
			<ul>
				<li><strong>Студент/Префікс:</strong> ${STUDENT}</li>
				<li><strong>Віртуальний хост (Server Name):</strong> ${SERVER_NAME}</li>
				<li><strong>Шлях до Document Root:</strong> ${DOC_ROOT}</li>
				<li><strong>Активний порт:</strong> ${WEB_PORT}</li>
				<li><strong>Час генерації сторінки:</strong> $(date)</li>
			</ul>
		</div>
  </body>
</html>
